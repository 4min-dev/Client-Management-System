...
export class StationController {
  ...
  async synchronizeOptions(
    ...
    const responseDto = new SynchronizeOptionsDto(
      station.pistolCount,
      station.procCount,
      station.stationsOptions.shiftNotificationEnabled,
      station.stationsOptions.calibrationNotificationEnabled,
      station.stationsOptions.seasonNotificationEnabled,
      station.stationsOptions.receiptCoefficientEnabled,
      station.stationsOptions.fixshiftNotificationEnabled,
